...
We have ranked the risks and provide our proposals for mitigation following the principles.
\begin{enumerate}
...
By assigning clients user credentials we can identify them and separate them into different roles that we might need and do Separation of Privilege.
