...
We have chosen the following privileges to use in our system.
% why
\begin{itemize}
...
Local disasters cause downtime and data loss & Reports of service outage & L & Loss of potential users\\\hline
A user is subject to social engineering & Reports of peculiar activity & H & SLA violation \\\hline
...
\begin{table}[h!]
	\begin{tabular}{| l | p{3cm} | l | l |}
		\hline
		\textbf{Risk} & \textbf{Indicator} & \textbf{L} & \textbf{Impact}  \\ \hline
        User login bruteforcing & Logs are full of login attempts & M & 6 \\ \hline
        Old libraries and platforms provide an easy target & Bugtrac is full of bugs & H & 9 \\\hline
        %TR5 & SQL injections & 80\% & 9 & Prepared statements and input sanitization \\ \hline
        User session hijacking & Reports from users of peculiar data & M & 4 \\ \hline
        Hardware failure & Downtime & L & 5 \\ \hline
	\end{tabular}
...
\begin{table}[h!]
    ...
    The server must provide 99.95\% uptime & Local disasters cause downtime and data loss &  Hardware failure \\ \hline
