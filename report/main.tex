...
\section{Testing}
In order to ensure that our service works as intended and do not have any immediate flaws we have conducted a series of tests.
...
\item Creating user
%Not implememted \item Renewing password 
\end{itemize}
...
SQL injections, XSS, race conditions

\subsection{Problems}


\section{Conclusion}
Our final products live up the expectations we put down during development.
